...
{
	[BloxBlock("Maths/Bitwise/a >> b [right-shift]", BloxBlockType.Value, Order = 500, OverrideRenderFields = 4, ReturnType = typeof(object), ParamNames = new string[]
	{
		"!a",
		"!b",
		">>"
	...
	public class B_RS_Block : BloxBlock
	{
